...
if (isset($_POST['btnSearch'])) {
	...
	if ($rdoSearchType == 1) {
		...
		$query = "SELECT * from purchase WHERE order_Date BETWEEN '$From' AND '$To'";
		$ret = mysqli_query($connection, $query);
	} else {
		...
		$query = "SELECT * from purchase where status = '$Status'";
		$ret = mysqli_query($connection, $query);
	}
...
<body>
	...
	<form action="PurchaseOrder_List.php" method="post" class="white-popup-block"  style="padding-top:0%;">
		<div class="popup_box">
			<div class="popup_inner">
				...
				<h3 style="text-align:center;">Purchase Order List</h3>
				<fieldset style="padding:25px;color:black">
					...
					<table class="table table-hover table-responsive">
						...
						for ($i = 0; $i < $count; $i++) {
							...
							echo "<td>
			  <a href='PurchaseOrder_Detail.php?PurchaseOrderID=$PurchaseOrderID' style = 'color:blue;'>Detail...</a>
			  </td>";
							echo "</tr>";
						}
