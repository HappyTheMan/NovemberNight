...
if (isset($_POST['btnConfirm'])) {
  ...
  $supID = $_SESSION['SupplierID'];
	...
	if ($ret) //True
	{
		...
		echo "<script>window.location='PurchaseOrder_List.php'</script>";
	} else {
...
<body>
	<div class="popup_box" style = "margin-top:8%;width:100%;">
		<div class="popup_inner">
			...
			<div class="line"></div>
			<form class="form" method="post" action="PurchaseOrder_Detail.php">
			<div class="col-xl-12">
