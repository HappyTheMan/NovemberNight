...
<div class="container">
	...
	<div class="popup_box" style="width: 100%;margin-left:3%;">
        ...
        border-radius:100%;'> </td>";
							...
							echo "<td>" . $type['menu_Type'] . "</td>";
							echo "<td>" . $rows['menu_Price']   . " $</td>";
							echo "<td>" . $rows['menu_Duration']   . " min</td>";
							echo "<td>" . $rows['Ingredient']   . "</td>";
							echo "<td>" . $rows['status']   . "</td>";
							echo "<td>

			  <a href='Menu_Update.php?MenuID=$ID' style = 'color:blue;'><button type='button' class='btn btn-primary btn-sm act'>Update</button></a>
			  <a href='Menu_Delete.php?MenuID=$ID' style = 'color:blue;'><button type='button' class='btn btn-danger btn-sm act'> Delete</button></a>
			  </td>";
							echo "</tr>";
						}
						?>
